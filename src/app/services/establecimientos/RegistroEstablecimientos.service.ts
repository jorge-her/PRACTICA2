...
export class RegistroEstablecimientos {
  ...
  public datos: Establecimiento[] = [
      {id:0 , nombre:'El Ristorante Di Giorgio', tipo_comida:1, distancia:1.2, aforo_actual:10, aforo_maximo:35, direccion:'Calle de Abizanda, 12', valoracion:4.3, medidas_covid:['Máximo número de personas por mesa: 6', 'Aforo limitado', 'Distancia interpersonal: 2 (metros)'], terraza:false, imagen:'https://media.cntraveler.com/photos/5ce2f3aa039dbab7d32508da/master/pass/Dos%20Cielos%20Madrid%20by%20Hermanos%20Torres_2019_59aGranMeliaPalacioDeLosDuques-DosCielosMadridRestaurant.jpg'},
